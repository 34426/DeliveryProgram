...
public class DingdanpeisongController {
    ...
    public R page(@RequestParam Map<String, Object> params,DingdanpeisongEntity dingdanpeisong,
                    ...
                    dingdanpeisong.setGonghao((String)request.getSession().getAttribute("username"));
                                    }
    ...
    public R value(@PathVariable("yColumnName") String yColumnName, @PathVariable("xColumnName") String xColumnName,HttpServletRequest request) {
        ...
        List<Map<String, Object>> result = MPUtil.snakeListToCamel(dingdanpeisongService.selectValue(params, ew));
    ...
    public R valueDay(@PathVariable("yColumnName") String yColumnName, @PathVariable("xColumnName") String xColumnName, @PathVariable("timeStatType") String timeStatType,HttpServletRequest request) {
        ...
        List<Map<String, Object>> result = MPUtil.snakeListToCamel(dingdanpeisongService.selectTimeStatValue(params, ew));
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        for(Map<String, Object> m : result) {
            for(String k : m.keySet()) {
                if(m.get(k) instanceof Date) {
    ...
    public R group(@PathVariable("columnName") String columnName,HttpServletRequest request) {
        ...
        List<Map<String, Object>> result = MPUtil.snakeListToCamel(dingdanpeisongService.selectGroup(params, ew));
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        for(Map<String, Object> m : result) {
            for(String k : m.keySet()) {
                if(m.get(k) instanceof Date) {
    ...
    public R count(@RequestParam Map<String, Object> params,DingdanpeisongEntity dingdanpeisong, HttpServletRequest request){
        String tableName = request.getSession().getAttribute("tableName").toString();
        if(tableName.equals("peisongyuan")) {
            dingdanpeisong.setGonghao((String)request.getSession().getAttribute("username"));
        }
        ...
        EntityWrapper<DingdanpeisongEntity> ew = new EntityWrapper<DingdanpeisongEntity>();
        int count = dingdanpeisongService.selectCount(MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, dingdanpeisong), params), params));
