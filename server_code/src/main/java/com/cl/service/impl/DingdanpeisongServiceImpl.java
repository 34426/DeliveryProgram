...
public class DingdanpeisongServiceImpl extends ServiceImpl<DingdanpeisongDao, DingdanpeisongEntity> implements DingdanpeisongService {
    ...
    @Override
    public List<Map<String, Object>> selectValue(Map<String, Object> params, Wrapper<DingdanpeisongEntity> wrapper) {
        return baseMapper.selectValue(params, wrapper);
    }

    @Override
    public List<Map<String, Object>> selectTimeStatValue(Map<String, Object> params, Wrapper<DingdanpeisongEntity> wrapper) {
        return baseMapper.selectTimeStatValue(params, wrapper);
    }

    @Override
    public List<Map<String, Object>> selectGroup(Map<String, Object> params, Wrapper<DingdanpeisongEntity> wrapper) {
