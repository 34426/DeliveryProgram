...
public class DingdanpeisongEntity<T> implements Serializable {
	...
	private String songdaxiangqing;
	 ...
	 * 设置：送达详情
	 */
	public void setSongdaxiangqing(String songdaxiangqing) {
		this.songdaxiangqing = songdaxiangqing;
	}
	/**
	 * 获取：送达详情
	 */
	public String getSongdaxiangqing() {
		return songdaxiangqing;
	}
